...
use Academy\setasign\Fpdi\PdfParser\Filter\FilterException;
use Academy\setasign\Fpdi\PdfParser\PdfParser;
use Academy\setasign\Fpdi\PdfParser\PdfParserException;
use Academy\setasign\Fpdi\PdfParser\StreamReader;
use Academy\setasign\Fpdi\PdfParser\Type\PdfArray;
use Academy\setasign\Fpdi\PdfParser\Type\PdfBoolean;
use Academy\setasign\Fpdi\PdfParser\Type\PdfDictionary;
use Academy\setasign\Fpdi\PdfParser\Type\PdfHexString;
use Academy\setasign\Fpdi\PdfParser\Type\PdfIndirectObject;
use Academy\setasign\Fpdi\PdfParser\Type\PdfIndirectObjectReference;
use Academy\setasign\Fpdi\PdfParser\Type\PdfName;
use Academy\setasign\Fpdi\PdfParser\Type\PdfNull;
use Academy\setasign\Fpdi\PdfParser\Type\PdfNumeric;
use Academy\setasign\Fpdi\PdfParser\Type\PdfStream;
use Academy\setasign\Fpdi\PdfParser\Type\PdfString;
use Academy\setasign\Fpdi\PdfParser\Type\PdfToken;
use Academy\setasign\Fpdi\PdfParser\Type\PdfType;
use Academy\setasign\Fpdi\PdfParser\Type\PdfTypeException;
use Academy\setasign\Fpdi\PdfReader\DataStructure\Rectangle;
use Academy\setasign\Fpdi\PdfReader\PageBoundaries;
use Academy\setasign\Fpdi\PdfReader\PdfReader;
use Academy\setasign\Fpdi\PdfReader\PdfReaderException;
