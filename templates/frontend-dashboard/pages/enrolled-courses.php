...
if ( ! defined( 'ABSPATH' ) ) {
	...
	\Academy\Helper::get_template(
		...
		[
			'menu' => apply_filters('academy/templates/frontend-dashboard/enrolled-courses-content-menu', [
...
<div class="academy-dashboard-enrolled-courses academy-dashboard__content">		        
	<div class="academy-row"> 
					<?php if ( ! empty( $enrolled_courses ) ) : ?>
						...
						<div class="academy-mycourse academy-mycourse-<?php echo esc_html( $course_id ); ?>">
					...
					<?php endforeach; ?>
					<?php else : ?>
						<h3 class="academy-not-found"><?php echo esc_html__( 'You have not enrolled any course yet.', 'academy' ); ?></h3>
					<?php endif; ?>
		</div>
	</div>
</div>
