...
namespace Academy\Mpdf\PsrHttpMessageShim;

use Academy\Psr\Http\Message\StreamInterface;
use Academy\Psr\Http\Message\ResponseInterface;
use Academy\Psr\Http\Message\MessageInterface;
 ...
 */
class Response implements \Academy\Psr\Http\Message\ResponseInterface
{
	...
	/** @var \Academy\Psr\Http\Message\StreamInterface */
	private $stream;
