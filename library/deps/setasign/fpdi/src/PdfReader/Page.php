...
namespace Academy\setasign\Fpdi\PdfReader;

use Academy\setasign\Fpdi\FpdiException;
use Academy\setasign\Fpdi\GraphicsState;
use Academy\setasign\Fpdi\Math\Vector;
