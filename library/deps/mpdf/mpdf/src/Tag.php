...
class Tag
{
	...
	/**
	 * @param \Academy\Mpdf\Mpdf $mpdf
	 * @param \Academy\Mpdf\Cache $cache
	 * @param \Academy\Mpdf\CssManager $cssManager
	 * @param \Academy\Mpdf\Form $form
	 * @param \Academy\Mpdf\Otl $otl
	 * @param \Academy\Mpdf\TableOfContents $tableOfContents
	 * @param \Academy\Mpdf\SizeConverter $sizeConverter
	 * @param \Academy\Mpdf\Color\ColorConverter $colorConverter
	 * @param \Academy\Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \Academy\Mpdf\Language\LanguageToFontInterface $languageToFont
	 */
